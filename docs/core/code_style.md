...
- **[models.md](https://github.com/greatstrength/tiferet/blob/main/docs/core/models.md)** – Model-specific conventions (dual role, mutation helpers, factory methods).
- **[commands.md](https://github.com/greatstrength/tiferet/blob/main/docs/core/commands.md)** – Command-specific conventions (dependency injection, validation, return patterns, static commands).
