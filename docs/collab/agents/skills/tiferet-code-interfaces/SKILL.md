...
- Do **not** define a Service for a concern nothing implements. An ABC with zero implementers and zero consumers is an artifact without a consumer and should be retired — this is why `ConfigurationService` no longer exists.
