...
class TestTesterObject:
    ...
    # * test: optional_fields_default_empty
    ...
    # * test: derive_expected_data_from_sample_data
    ...
    # * test: dependencies_validate_nested_dicts
...
# ** tester: test_verification
class TestVerification:
    '''
    Tests for Verification construction.
    '''

    # * test: constructs_with_predicate_and_source
...
class TestTesterObjectRepoType:
    ...
    # * test: repo_field_set_model_validates
    ...
    # * test: repo_tester_object_absent
...
class TestTesterObjectContextType:
    ...
    # * test: context_tester_object_absent
    ...
    # * test: optional_context_fields_default_empty
