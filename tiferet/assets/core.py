...
class TiferetError(Exception):
    ...
    def raise_error(cls, error_code: str, message: str = None, **kwargs) -> NoReturn:
        ...
        Called on TiferetError this raises a TiferetError; called on a
        subclass (e.g. TiferetAPIError) it raises that subclass instead,
        the dispatch a staticmethod cannot provide.
