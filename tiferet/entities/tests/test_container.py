...
# ** fixture: container_attribute_multiple_deps
@pytest.fixture
def container_attribute_multiple_deps(
    flagged_dependency: FlaggedDependency,
    flagged_dependency_to_add: FlaggedDependency
) -> ContainerAttribute:
    '''
    Fixture to create a ContainerAttribute instance with multiple flagged dependencies for testing.
...
# ** test: container_attribute_get_dependency_multiple_flags
def test_container_attribute_get_dependency_multiple_flags(
    container_attribute_multiple_deps: ContainerAttribute,
    flagged_dependency: FlaggedDependency,
    flagged_dependency_to_add: FlaggedDependency
):
    '''
    ...
    :param container_attribute_multiple_deps: The container attribute with multiple dependencies.
    :type container_attribute_multiple_deps: ContainerAttribute
    :param flagged_dependency: The first flagged dependency (test_alpha).
    :type flagged_dependency: FlaggedDependency
    :param flagged_dependency_to_add: The second flagged dependency (test_beta).
    :type flagged_dependency_to_add: FlaggedDependency
    ...
    dependency = container_attribute_multiple_deps.get_dependency('test_alpha', 'test_beta')
    assert dependency.module_path == flagged_dependency.module_path
    assert dependency.class_name == flagged_dependency.class_name
    assert dependency.flag == flagged_dependency.flag
    assert dependency.parameters == flagged_dependency.parameters
    ...
    dependency = container_attribute_multiple_deps.get_dependency('test_beta', 'test_alpha')
